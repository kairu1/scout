//! Fuzzy scoring behind a swappable trait. `nucleo-matcher` is the
//! implementation; the trait is the seam that lets it be replaced without
//! touching the ranking pipeline.
