//! Machine-readable output (ADR-008).
//!
...
/// ADR-008: an exit code that never varies carries no information.
#[test]
...
/// The hazard ADR-008 exists to neutralise: a tab inside a path. Field
